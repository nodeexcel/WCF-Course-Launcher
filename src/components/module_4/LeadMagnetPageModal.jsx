...
export const LeadMagnetPageModal = ({ onClose }) => {
  const formConfig = courseForms['Content for lead magnet page'] || [];
  ...
  const handleSubmit = async (e) => {
    ...
    const url = `${API_BASE_URL}/module4/lead-magnet-content`;
    const payload = {
      lead_magnet_type: formData.lead_magnet_type || "",
      lead_magnet_title: formData.lead_magnet_title || "",
      ...
      unique_approach: formData.unique_approach || "",
      benefits: formData.benefits || "",
      includes_tools: formData.includes_tools || "",
      tone: formData.tone || "",
      header_styles: formData.header_style || ""
    };
    try {
  ...
  return (
    <div className="fixed bottom-20 right-6 z-50 w-[400px] h-[450px] bg-white rounded-xl shadow-2xl flex flex-col border border-gray-200">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-[#5035f6] rounded-t-xl">
        <h2 className="text-[15px] font-bold text-white">Content for Lead Magnet Page</h2>
        <button
